...
class ParksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create park" do
    assert_difference('Park.count') do
      post parks_url, params: { park: { address: @park.address, lat: @park.lat, lon: @park.lon, name: @park.name } }, as: :json
    end
  ...
  test "should update park" do
    patch park_url(@park), params: { park: { address: @park.address, lat: @park.lat, lon: @park.lon, name: @park.name } }, as: :json
    assert_response 200
  end
